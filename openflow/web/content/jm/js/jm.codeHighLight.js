...
* @requires $jm
**/
$jm.code = function (lan, code) {
    //缓存或生成高亮代码引擎
    var dp = $jm.cache.set('jm.code.dp', $jm.cache.get('jm.code.dp') || $jm.code.createDP());
    ...
    var container = $('<div class="dp-css" />');
    container.append(ht.div);
...
dp.sh.Brushes.Vb = function () {
    var keywords = 'AddHandler AddressOf AndAlso Alias And Ansi As Assembly Auto ' +
	                ...
	                '\#region \#endregion abstract as base bool break byte case catch char checked class const ' +
					'continue decimal default delegate do double else enum event explicit ' +
					'extern false finally fixed float for foreach get goto if implicit in int ' +
					'interface internal is lock long namespace new null object operator out ' +
					'override params private protected public readonly ref return sbyte sealed set ' +
					'short sizeof stackalloc static string struct switch this throw true try ' +
					'typeof uint ulong unchecked unsafe ushort using virtual void while value ' +
					"delegate";

    var objectkey = "Assembly MethodInfo Type Dictionary List ConfigurationManager XmlNode XmlDocument Exception " +
                    "XmlAttribute XmlNodeType GC StructLayout LayoutKind Activator FileStream GZipStream FileMode FileAccess " +
                    "Console CompressionMode Path FileShare MemoryStream IAsyncResult DeflateStream TableRow Table Unit WebControl TableCell " +
                    "HtmlControl Label ArrayList UnicodeEncoding Byte Regex StreamReader StreamWriter Encoding Directory File PropertyInfo " +
                    "DataTable DataSet SeekOrigin FileInfo DirectoryInfo XmlSerializer RegistryKey Registry FileAttributes IntPtr Icon DllImport StringBuilder String " +
                    "CharSet MarshalAs UnmanagedType Thread ThreadStart BinaryFormatter DateTime TextWriter TestReader Process ProcessWindowStyle Application ConsoleColor " +
                    "Serializable ChannelType SecurityPermission SecurityAction IChannel IDictionary BinaryServerFormatterSinkProvider TypeFilterLevel TcpServerChannel " +
                    "RemotingConfiguration CustomErrorsModes ChannelServices ChannelDataStore Hashtable WellKnownServiceTypeEntry HttpServerChannel MarshalByRefObject ObjRef " +
                    "BinaryServerFormatterSinkProvider BinaryClientFormatterSinkProvider TcpChannel Activator Object DESCryptoServiceProvider CryptoStream CryptoStreamMode CryptoStreamMode " +
                    "RC2CryptoServiceProvider MD5 BitConverter SHA1 ServiceController OleDbCommand OleDbDataAdapter Bitmap Rectangle PixelFormat ImageLockMode BitmapData Convert Int64 Int32 Int16";
    ...
    this.regexList = [
		...
		{regex: new RegExp(this.GetKeywords(objectkey), 'gm'), css: 'objectkey'}			// c# objectkey		
		];
...
dp.sh.Brushes.CSharp = function () {
    var keywords = '\#region \#endregion abstract as base bool break byte case catch char checked class const ' +
					'continue decimal default delegate do double else enum event explicit ' +
					'extern false finally fixed float for foreach get goto if implicit in int ' +
					'interface internal is lock long namespace new null object operator out ' +
					'override params private protected public readonly ref return sbyte sealed set ' +
    ...
    var objectkey = "Assembly MethodInfo Type Dictionary List ConfigurationManager XmlNode XmlDocument Exception " +
                    ...
                    "RemotingConfiguration CustomErrorsModes ChannelServices ChannelDataStore Hashtable WellKnownServiceTypeEntry HttpServerChannel MarshalByRefObject ObjRef " +
                    "BinaryServerFormatterSinkProvider BinaryClientFormatterSinkProvider TcpChannel Activator Object DESCryptoServiceProvider CryptoStream CryptoStreamMode CryptoStreamMode " +
                    "RC2CryptoServiceProvider MD5 BitConverter SHA1 ServiceController OleDbCommand OleDbDataAdapter Bitmap Rectangle PixelFormat ImageLockMode BitmapData Convert Int64 Int32 Int16 Socket";
